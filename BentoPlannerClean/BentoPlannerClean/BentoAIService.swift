                ...
                [
                    "parts": [
                        [
                            ...
                            【絶対厳守ルール1: 料理名と材料の完全一致】
                            料理名に書いた食材・調味料は**必ず全て**材料リストに含めること。

                            ❌NG例:
                            - 料理名「鮭のディル風味」→ 材料に「ディル」がない
                            - 料理名「鶏のバジルペスト」→ 材料に「バジル」がない
                            - 料理名「豚肉のレモンソテー」→ 材料に「レモン」がない

                            ✅OK例:
                            - 料理名「鮭のディル風味」→ 材料に「鮭切り身」「ディル」「塩」「バター」
                            - 料理名「鶏のバジルペスト」→ 材料に「鶏もも肉」「バジル」「にんにく」「オリーブオイル」
                            - 料理名「豚肉のレモンソテー」→ 材料に「豚ロース」「レモン」「塩」「バター」

                            【絶対厳守ルール2: 副菜は毎回全て異なる調理法】
                            1つのお弁当に6つの副菜（3レシピ×2副菜）が含まれますが、これら6つは**完全に異なる調理法**にすること。

                            ❌NG例: 「ひじきの煮物」「しいたけの煮物」「人参の煮物」← 煮物が3つも！
                            ✅OK例: 「ほうれん草の胡麻和え」「ブロッコリーのガーリック炒め」「人参グラッセ」「いんげんのナムル」「オクラのおかか和え」「パプリカのマリネ」

                            【絶対厳守ルール3: 毎回必ず異なるメイン料理】
                            「鮭の塩焼き」のような同じメニューは絶対に繰り返さないこと。

                            \(prompt)

                            【🔥 調理法の多様性強制 🔥】
                            3つのレシピは必ず異なる調理法で：
                            - 焼き物：塩焼き、味噌焼き、粕漬け焼き、山椒焼き、ムニエル
                            - 揚げ物：唐揚げ、竜田揚げ、天ぷら、フライ、カツ
                            - 炒め物：生姜炒め、ピリ辛炒め、カレー炒め、ガーリック炒め
                            - 煮物：煮付け、味噌煮、甘辛煮、角煮、煮込み
                            - その他：蒸し物、南蛮漬け、マリネ、ピカタ、チーズ焼き
                            ...
                            **料理名に含まれる食材・調味料は必ず材料リストに記載すること**
                            ...
                            【🚨 副菜の強制多様化・煮物系を最小限に】
                            ❌ 同じお弁当の中で同じ調理法の副菜は絶対禁止
                            ❌NG例: 副菜1「ひじきの煮物」+ 副菜2「しいたけの煮物」← 煮物が2つ！

                            ❌ 副菜で揚げ物絶対禁止：唐揚げ、フライ、天ぷら、コロッケ、カツ（これらはメイン料理です）
                            ❌ 副菜で肉類禁止：鶏の香味揚げ、豚バラ炒め、牛肉炒め（これらはメイン料理です）

                            ✅ 副菜の調理法例（6つ全て異なる調理法にする）：
                            1. 和え物：胡麻和え、ナムル、おかか和え、ポン酢和え
                            2. 炒め物：ガーリック炒め、バター炒め、ごま油炒め
                            3. グラッセ：人参グラッセ、かぶのグラッセ
                            4. マリネ：パプリカマリネ、きのこマリネ、ズッキーニマリネ
                            ...
                            {"recipes": [
                              {
                                "name": "鶏のバジルペスト弁当",
                                "description": "イタリア風のバジルが香る洋風弁当",
                                "mainDish": {
                                  "name": "鶏のバジルペスト焼き",
                                  "ingredients": ["鶏もも肉 200g", "バジル 10枚", "にんにく 1片", "オリーブオイル 大さじ2", "パルメザンチーズ 大さじ1", "塩 少々", "黒こしょう 少々"],
                                  "instructions": ["鶏もも肉を一口大に切る", "バジル、にんにく、オリーブオイル、チーズを混ぜてペーストを作る", "鶏肉にペーストを塗り込む", "フライパンで両面をこんがり焼く", "よく冷ましてからお弁当箱に詰める"]
                                },
                                "sideDish1": {
                                  "name": "ブロッコリーのガーリック炒め",
                                  "ingredients": ["ブロッコリー 100g", "にんにく 1片", "オリーブオイル 大さじ1", "塩 少々"],
                                  "instructions": ["ブロッコリーを小房に分ける", "にんにくを薄切りにする", "フライパンで炒める", "冷ましてお弁当箱に詰める"]
                                },
                                "sideDish2": {
                                  "name": "パプリカのバルサミコマリネ",
                                  "ingredients": ["赤パプリカ 1/2個", "バルサミコ酢 大さじ1", "オリーブオイル 大さじ1", "塩 少々"],
                                  "instructions": ["パプリカを細切りにする", "調味料と和える", "10分置く", "お弁当箱に詰める"]
                                },
                                "prepTime": 25,
                                "calories": 450,
                                "difficulty": "easy",
                                "tips": ["バジルは新鮮なものを使うと香りが良い"]
                              },
                              {
                                "name": "具体的料理名弁当2", 
                                "description": "簡潔な説明", 
                            ...
                            【🔍 出力前の最終チェック - 必ず全項目確認すること】

                            ✅ チェック1: 料理名と材料の一致
                            - 「鮭のディル風味」→材料に「ディル」があるか？
                            - 「鶏のバジルペスト」→材料に「バジル」があるか？
                            - 「豚肉のレモンソテー」→材料に「レモン」があるか？
                            ❌ 料理名に含まれる食材が材料リストにない場合は出力禁止

                            ✅ チェック2: 副菜の調理法が全て異なるか
                            - 6つの副菜（3レシピ×2副菜）が全て異なる調理法か？
                            - 「煮物」が2つ以上ないか？
                            - 「炒め物」が3つ以上ないか？
                            ❌ 同じ調理法の副菜がある場合は出力禁止

                            ✅ チェック3: メイン料理の重複
                            - 「鮭の塩焼き」「鶏の照り焼き」など定番が連続していないか？
                            - 前回と異なる魚種・肉種を使っているか？
                            ❌ 同じメイン料理は絶対禁止
